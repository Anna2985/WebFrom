...
namespace WebFrom
{
    public partial class index : System.Web.UI.Page
    {
        ...
        {
            string content = index.GetJsonContent("https://www.ktec.gov.tw/ktec_api.php?type=json");
            ...
            foreach (var item in data.entries)
            {
                ...
                {
                    message.InnerHtml += "<tr>" + "<td>" + item.category + "</td>" + "<td><a href=\"detail.aspx?i=" + i + "\">" + item.title + "</a></td>" + "<td>" + item.publication_date + "</td></tr>";
                    i++;
                }
            }
